...
/**
 * @brief Műhold adatbázis
 * @details A GSV üzenetekből származó műhold információkat tárolja. A műholdak PRN száma alapján azonosítja őket, és lehetővé teszi a műholdak rendezését különböző szempontok szerint.
 *
 */
class SatelliteDb {
  public:
