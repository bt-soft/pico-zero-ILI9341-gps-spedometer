...
class ScreenTest : public UIScreen, public ButtonsGroupManager<ScreenTest> {
  ...
  public:
     ...
     * Felszabadítja az összes erőforrást, ha szükséges.
     * A gyerek komponensek shared_ptr-ek, így automatikusan felszabadulnak, ha már nincs rájuk szükség.
     */
    ...
    virtual void drawContent() override {
        ...
        // Információs szöveg
        tft.setTextSize(1);
        tft.drawString("ScreenTest for debugging", tft.width() / 2, tft.height() / 2 + 20);
    }
